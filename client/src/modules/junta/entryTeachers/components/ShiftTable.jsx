...
const COLUMNS = ["#", "Año", "Tipo", "Fecha", "Hora", "Libre", "Acciones"];
        ...
        {rows.map((row, i) => {
          return (
            <div className="border-b border-gray-300 py-2" key={i}>
              ...
              <span className="text-gray-300 text-md font-light">
                {COLUMNS[5]}: {row.teacherId ? "Ocupado" : "Libre"}
              </span>
              <span className="text-gray-300 text-md font-light block">
                acciones
              </span>
